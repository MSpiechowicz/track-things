<script lang="ts">
	import { defaultAdditionalClass, defaultStrokeColor } from '$lib/components/svg/defaults';
...
<svg
	...
	class="icon icon-tabler icons-tabler-outline icon-tabler-calendar-clock {additionalClass}"
	><path stroke="none" d="M0 0h24v24H0z" fill="none" /><path
		d="M10.5 21h-4.5a2 2 0 0 1 -2 -2v-12a2 2 0 0 1 2 -2h12a2 2 0 0 1 2 2v3"
	/><path d="M16 3v4" /><path d="M8 3v4" /><path d="M4 11h10" /><path
