...
<svg
	...
	class="icon icon-tabler icons-tabler-outline icon-tabler-network-off {additionalClass}"
	...
	/><path d="M6 9h3m4 0h5" /><path d="M3 20h7" /><path d="M14 20h7" /><path
		d="M10 20a2 2 0 1 0 4 0a2 2 0 0 0 -4 0"
	/><path d="M12 15v3" /><path d="M3 3l18 18" /></svg
>
