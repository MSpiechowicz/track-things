...
<svg
	...
	class="icon icon-tabler icons-tabler-outline icon-tabler-arrow-back-up {additionalClass}"
	><path stroke="none" d="M0 0h24v24H0z" fill="none" /><path d="M9 14l-4 -4l4 -4" /><path
